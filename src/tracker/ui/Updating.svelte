            ...
            <div class="updating-hp">
                ...
                <div class="hp-status">
                    {#if plugin.data.beginnerTips}
                        <small class="label">
                            Apply damage, (-)healing, (t)temp HP, (m)max HP, or (s)set max HP
                        </small>
                    {/if}
                    <div class="input">
                        <tag
                            use:hpIcon
                            aria-label="Apply damage, (-)healing, (t)temp HP, (m)max HP, or (s)set max HP"
                        ...
                        <input
                            ...
                            on:keydown={function (evt) {
                                ...
                                if (
                                    !/^((t|m|s)?-?\d*\.?\d*(Backspace|Delete|Arrow\w+)?)$/.test(
                                        this.value + evt.key
                                    )
                                ) {
                                    evt.preventDefault();
